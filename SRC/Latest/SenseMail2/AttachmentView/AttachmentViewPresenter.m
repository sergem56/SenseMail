...
// Not used yet
-(void)showNextAttachment
{
    [[[GlobalRouter sharedManager] getMessageRouter] wantShowNextAttachment:YES];
}

-(void)showPrevAttachment
{
    [[[GlobalRouter sharedManager] getMessageRouter] wantShowNextAttachment:NO];
}
